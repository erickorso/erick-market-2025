/**
 * Exponential backoff with jitter for the browser side.
 *
 * A copy of `api/_lib/retry.ts` rather than a shared module: the API bundles
 * under its own tsconfig and Vercel has already bitten this project once over
 * cross-boundary ESM imports at cold start. Twenty duplicated lines cost less
